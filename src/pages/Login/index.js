  ...
  return (
    <>
      <LoginLeftWrapper>
        ...
        <h2>Bem vindo(a) ao <br /> PharmAI. Assistente Virtual da sua saúde</h2>
      </LoginLeftWrapper>
      ...
      <LoginRightWrapper>
        ...
        <center>
          <h3>Saiba tudo sobre Farmácias, preços, bulas, recomendações e muito mais<br /> Farmacêutico Virtual</h3>
        </center>
